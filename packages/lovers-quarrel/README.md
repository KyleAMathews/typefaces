...
# typeface-lovers-quarrel

The CSS and web font files to easily self-host “Lovers Quarrel”.

## Install

`npm install --save typeface-lovers-quarrel`
...
require('typeface-lovers-quarrel')
```
