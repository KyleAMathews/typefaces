...
# typeface-butterfly-kids

The CSS and web font files to easily self-host “Butterfly Kids”.

## Install

`npm install --save typeface-butterfly-kids`
...
require('typeface-butterfly-kids')
```
