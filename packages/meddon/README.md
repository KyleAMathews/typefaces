...
"typeface-meddon" with "fontsource-meddon".
>
> Then change imports from "import 'typeface-meddon'" to "import 'fontsource-meddon/latin.css'".
>
...
The CSS and web font files to easily self-host “Meddon”.
