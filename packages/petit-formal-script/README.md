...
"typeface-petit-formal-script" with "fontsource-petit-formal-script".
>
> Then change imports from "import 'typeface-petit-formal-script'" to "import 'fontsource-petit-formal-script/latin.css'".
>
