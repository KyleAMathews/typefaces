...
"typeface-rambla" with "fontsource-rambla".
>
> Then change imports from "import 'typeface-rambla'" to "import 'fontsource-rambla/latin.css'".
>
...
The CSS and web font files to easily self-host “Rambla”.

## Install

`npm install --save typeface-rambla`
