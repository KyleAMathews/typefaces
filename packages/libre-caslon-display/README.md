...
"typeface-libre-caslon-display" with "fontsource-libre-caslon-display".
>
> Then change imports from "import 'typeface-libre-caslon-display'" to "import 'fontsource-libre-caslon-display/latin.css'".
>
