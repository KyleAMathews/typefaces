...
"typeface-saira" with "fontsource-saira".
>
> Then change imports from "import 'typeface-saira'" to "import 'fontsource-saira/latin.css'".
>
...
The CSS and web font files to easily self-host “Saira”.

## Install

`npm install --save typeface-saira`
