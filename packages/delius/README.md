...
"typeface-delius" with "fontsource-delius".
>
> Then change imports from "import 'typeface-delius'" to "import 'fontsource-delius/latin.css'".
>
...
The CSS and web font files to easily self-host “Delius”.

## Install

`npm install --save typeface-delius`
