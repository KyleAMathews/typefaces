...
# typeface-croissant-one

The CSS and web font files to easily self-host “Croissant One”.

## Install

`npm install --save typeface-croissant-one`
...
require('typeface-croissant-one')
```
