...
"typeface-hind" with "fontsource-hind".
>
> Then change imports from "import 'typeface-hind'" to "import 'fontsource-hind/latin.css'".
>
...
The CSS and web font files to easily self-host “Hind”.

## Install

`npm install --save typeface-hind`
