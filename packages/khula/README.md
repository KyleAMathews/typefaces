...
"typeface-khula" with "fontsource-khula".
>
> Then change imports from "import 'typeface-khula'" to "import 'fontsource-khula/latin.css'".
>
...
The CSS and web font files to easily self-host “Khula”.

## Install

`npm install --save typeface-khula`
