...
"typeface-kalam" with "fontsource-kalam".
>
> Then change imports from "import 'typeface-kalam'" to "import 'fontsource-kalam/latin.css'".
>
...
The CSS and web font files to easily self-host “Kalam”.

## Install

`npm install --save typeface-kalam`
