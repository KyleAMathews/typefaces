...
# typeface-mrs-sheppards

The CSS and web font files to easily self-host “Mrs Sheppards”.

## Install

`npm install --save typeface-mrs-sheppards`
...
require('typeface-mrs-sheppards')
```
