...
"typeface-gugi" with "fontsource-gugi".
>
> Then change imports from "import 'typeface-gugi'" to "import 'fontsource-gugi/latin.css'".
>
...
The CSS and web font files to easily self-host “Gugi”.

## Install

`npm install --save typeface-gugi`
