...
"typeface-oxanium" with "fontsource-oxanium".
>
> Then change imports from "import 'typeface-oxanium'" to "import 'fontsource-oxanium/latin.css'".
>
...
The CSS and web font files to easily self-host “Oxanium”.

## Install

`npm install --save typeface-oxanium`
