...
"typeface-crimson-text" with "fontsource-crimson-text".
>
> Then change imports from "import 'typeface-crimson-text'" to "import 'fontsource-crimson-text/latin.css'".
>
...
`npm install --save typeface-crimson-text`
