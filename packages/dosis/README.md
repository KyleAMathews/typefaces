...
"typeface-dosis" with "fontsource-dosis".
>
> Then change imports from "import 'typeface-dosis'" to "import 'fontsource-dosis/latin.css'".
>
...
The CSS and web font files to easily self-host “Dosis”.

## Install

`npm install --save typeface-dosis`
