...
"typeface-faster-one" with "fontsource-faster-one".
>
> Then change imports from "import 'typeface-faster-one'" to "import 'fontsource-faster-one/latin.css'".
>
...
The CSS and web font files to easily self-host “Faster One”.

## Install

`npm install --save typeface-faster-one`
