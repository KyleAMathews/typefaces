...
"typeface-cantarell" with "fontsource-cantarell".
>
> Then change imports from "import 'typeface-cantarell'" to "import 'fontsource-cantarell/latin.css'".
>
...
The CSS and web font files to easily self-host “Cantarell”.

## Install

`npm install --save typeface-cantarell`
