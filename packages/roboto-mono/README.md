...
"typeface-roboto-mono" with "fontsource-roboto-mono".
>
> Then change imports from "import 'typeface-roboto-mono'" to "import 'fontsource-roboto-mono/latin.css'".
>
...
The CSS and web font files to easily self-host “Roboto Mono”.
