...
"typeface-dancing-script" with "fontsource-dancing-script".
>
> Then change imports from "import 'typeface-dancing-script'" to "import 'fontsource-dancing-script/latin.css'".
>
