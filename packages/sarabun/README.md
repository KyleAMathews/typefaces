...
"typeface-sarabun" with "fontsource-sarabun".
>
> Then change imports from "import 'typeface-sarabun'" to "import 'fontsource-sarabun/latin.css'".
>
...
The CSS and web font files to easily self-host “Sarabun”.

## Install

`npm install --save typeface-sarabun`
