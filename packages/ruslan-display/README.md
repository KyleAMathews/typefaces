...
# typeface-ruslan-display

The CSS and web font files to easily self-host “Ruslan Display”.

## Install

`npm install --save typeface-ruslan-display`
...
require('typeface-ruslan-display')
```
