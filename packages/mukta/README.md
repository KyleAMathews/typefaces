...
"typeface-mukta" with "fontsource-mukta".
>
> Then change imports from "import 'typeface-mukta'" to "import 'fontsource-mukta/latin.css'".
>
...
The CSS and web font files to easily self-host “Mukta”.

## Install

`npm install --save typeface-mukta`
