...
# typeface-give-you-glory

The CSS and web font files to easily self-host “Give You Glory”.

## Install

`npm install --save typeface-give-you-glory`
...
require('typeface-give-you-glory')
```
