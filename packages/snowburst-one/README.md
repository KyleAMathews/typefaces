...
"typeface-snowburst-one" with "fontsource-snowburst-one".
>
> Then change imports from "import 'typeface-snowburst-one'" to "import 'fontsource-snowburst-one/latin.css'".
>
