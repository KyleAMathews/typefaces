...
"typeface-gudea" with "fontsource-gudea".
>
> Then change imports from "import 'typeface-gudea'" to "import 'fontsource-gudea/latin.css'".
>
...
The CSS and web font files to easily self-host “Gudea”.

## Install

`npm install --save typeface-gudea`
