...
"typeface-coustard" with "fontsource-coustard".
>
> Then change imports from "import 'typeface-coustard'" to "import 'fontsource-coustard/latin.css'".
>
...
The CSS and web font files to easily self-host “Coustard”.

## Install

`npm install --save typeface-coustard`
