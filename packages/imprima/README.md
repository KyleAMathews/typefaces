...
"typeface-imprima" with "fontsource-imprima".
>
> Then change imports from "import 'typeface-imprima'" to "import 'fontsource-imprima/latin.css'".
>
...
The CSS and web font files to easily self-host “Imprima”.

## Install

`npm install --save typeface-imprima`
