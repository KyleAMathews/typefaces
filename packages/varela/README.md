...
"typeface-varela" with "fontsource-varela".
>
> Then change imports from "import 'typeface-varela'" to "import 'fontsource-varela/latin.css'".
>
...
The CSS and web font files to easily self-host “Varela”.

## Install

`npm install --save typeface-varela`
