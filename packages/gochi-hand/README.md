...
"typeface-gochi-hand" with "fontsource-gochi-hand".
>
> Then change imports from "import 'typeface-gochi-hand'" to "import 'fontsource-gochi-hand/latin.css'".
>
...
The CSS and web font files to easily self-host “Gochi Hand”.

## Install

`npm install --save typeface-gochi-hand`
