...
"typeface-dm-serif-text" with "fontsource-dm-serif-text".
>
> Then change imports from "import 'typeface-dm-serif-text'" to "import 'fontsource-dm-serif-text/latin.css'".
>
