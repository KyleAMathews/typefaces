...
"typeface-magra" with "fontsource-magra".
>
> Then change imports from "import 'typeface-magra'" to "import 'fontsource-magra/latin.css'".
>
...
The CSS and web font files to easily self-host “Magra”.

## Install

`npm install --save typeface-magra`
