...
"typeface-josefin-sans" with "fontsource-josefin-sans".
>
> Then change imports from "import 'typeface-josefin-sans'" to "import 'fontsource-josefin-sans/latin.css'".
>
...
The CSS and web font files to easily self-host “Josefin Sans”.

## Install

`npm install --save typeface-josefin-sans`
