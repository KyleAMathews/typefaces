...
"typeface-fira-sans-condensed" with "fontsource-fira-sans-condensed".
>
> Then change imports from "import 'typeface-fira-sans-condensed'" to "import 'fontsource-fira-sans-condensed/latin.css'".
>
...
The CSS and web font files to easily self-host “Fira Sans Condensed”.

## Install

`npm install --save typeface-fira-sans-condensed`
