...
"typeface-eczar" with "fontsource-eczar".
>
> Then change imports from "import 'typeface-eczar'" to "import 'fontsource-eczar/latin.css'".
>
...
The CSS and web font files to easily self-host “Eczar”.

## Install

`npm install --save typeface-eczar`
